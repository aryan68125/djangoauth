...
import os
#import heroku so that we can host our website on heroku online server pip3 install django-heroku if not present
...
SECRET_KEY = 'django-insecure-ka4i=b9f2+%h-7)38yb56v0i73j+dsxg*a1-v^%v2t55#o#xj0'
...
EMAIL_HOST_PASSWORD = 'IKYhmn7HbGvUszZa'
